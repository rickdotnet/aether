...
//         {
//             var store = (IStore)serviceProvider.GetRequiredService(storageRegistration.StoreType!);
//             aether.Storage.SetStore(storageRegistration.StoreName, store);
//         }
//     }
//
...
//         {
//             var hub = (IMessageHub)serviceProvider.GetRequiredService(hubRegistration.HubType);
//
...
//                          hub.AddHandler(
//                             endpointRegistration.Config,
//                             endpointRegistration.IsHandler
//                                 ? endpointRegistration.Handler!
//                                 : new AetherHandler(endpointRegistration.EndpointType!, endpointProvider).Handle);
//                          
//                          return Task.CompletedTask;
//                     });
